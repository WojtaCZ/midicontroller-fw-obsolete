...
void ssd1306_Init(void) {
    ...
    ssd1306_WriteBufferByte(screenBuffer, 0xC0); // Mirror vertically
#else
    ...
    ssd1306_WriteBufferByte(screenBuffer, 0xA0); // Mirror horizontally
#else
    ssd1306_WriteBufferByte(screenBuffer, 0xA1); //--set segment re-map 0 to 127 - CHECK
#endif

#ifdef SSD1306_INVERSE_COLOR
    ssd1306_WriteBufferByte(screenBuffer, 0xA7); //--set inverse color
#else
